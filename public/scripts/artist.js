document.addEventListener('DOMContentLoaded', () => {
  ...
  const addEditButtonListener = (editButton) => {
    editButton.addEventListener("click", (e) => {
      ...
      document.getElementById(`saveBtn${rowId}`).addEventListener("click", (e) => {
        ...
        if (row.children[2].textContent === 'null') {
  ...
  -----------------------------------------------------------------------------*/
  const artistInsertSubmitBtn = document.getElementById("artistInsertSubmit");
  artistInsertSubmitBtn.addEventListener("click", (e) => {
    const artistNameInput = document.getElementById("artistNameInput");
    if (!artistNameInput.value) {
      artistNameInput.classList.add("is-danger");
